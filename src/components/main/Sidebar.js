    ...
    return (
        <Nav className='bg-light sidebar' vertical={true}>
            <NavItem className='nav-item'>
                <NavLink className='nav-link' to='/LOK-DevTool/dashboard/lands'>
                    <i className="fa fa-map-signs feather" aria-hidden="true"></i>Lands
                </NavLink>
            </NavItem>
            <NavItem className='nav-item'>
                <NavLink className='nav-link' to='/LOK-DevTool/dashboard/members'>
                    <i className="fa fa-address-book-o feather" aria-hidden="true"></i>Members
                </NavLink>
            </NavItem>
            <NavItem className='nav-item'>
                <NavLink className='nav-link' to='/LOK-DevTool/dashboard/report'>
